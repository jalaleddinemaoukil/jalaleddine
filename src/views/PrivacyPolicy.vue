<template>
  <main class="legal-page">
    ...
    <section class="legal-body">
      <div class="shell legal-body__inner">
        <p>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Jalal Eddine Maoukil.</p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Jalal Eddine Maoukil, accessible from
              <a href="https://jalaleddine.me/" rel="external nofollow noopener" target="_blank">https://jalaleddine.me/</a>.
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          (if available) or through Your browser/device settings. Withdrawing consent does not affect the lawfulness
        ...
        <ul>
          <li><p>By email: jalaleddinemaoukil@gmail.com</p></li>
          <li>
            <p>
              By visiting this page on our website:
              <a href="https://www.linkedin.com/in/jalal-eddine-maoukil/" rel="external nofollow noopener" target="_blank">
...
useHead(buildHead("/privacy-policy", { title: "Privacy Policy | Jalal Eddine Maoukil" }));
</script>
...
.legal-hero {
  ...
  color: var(--color-ink);
  padding: clamp(6rem, 14vw, 9rem) var(--gutter) clamp(2rem, 6vw, 4rem);
}
